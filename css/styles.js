...
const styles = StyleSheet.create({
  ...
  account_img:{
	...
	notiicationContainerTop:{paddingBottom:0,flex:1},
	notiicationScroll:{
		padding:20
	},
	...
	notificationText:{marginLeft:1,marginTop:3,fontWeight:500},
